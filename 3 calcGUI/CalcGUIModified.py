...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        :return: None
        """
        self.sin_bttn = Button(self, text="sin", width=9, height=3, bg='LightBlue', fg='red',command=lambda: self.add_chr('sin'))
        self.sin_bttn.grid(row=2, column=6)

        self.cos_bttn = Button(self, text="cos", width=9, height=3, bg='LightBlue', fg='red',command=lambda: self.add_chr('cos'))
        self.cos_bttn.grid(row=3, column=6)

        self.tan_bttn = Button(self, text="tan", width=9, height=3, bg='LightBlue', fg='red',command=lambda: self.add_chr('tan'))
        ...
        self.one_bttn = Button(self, text="Chase", width=9, height=3,bg='LightBlue', fg='red', command=lambda: self.add_chr('MacDonald'))
